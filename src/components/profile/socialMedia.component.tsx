        ...
        return (
            <div>
                <div className="flex flex-row-reverse mb-6">
                    <a href="https://www.instagram.com/sajjadmrx/" target="_blank" rel={'noreferrer'}>
                    ...
                    <a href="https://twitter.com/sajjadmrx" target="_blank" rel={'noreferrer'}>
                        <svg className=" icon m-1 text-gray-300" fill="none" height="24"
                             stroke="currentColor"
                             strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                             viewBox="0 0 24 24"
                    ...
                    <a href="https://inkedin.com/in/sajjadmrx" target="_blank" rel={'noreferrer'}>
                        <svg className="icon m-1 text-gray-300" fill="none" height="24"
                             stroke="currentColor"
                             strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                             viewBox="0 0 24 24"
                    ...
                    <a href="https://github.com/sajjadmrx" target="_blank" rel={'noreferrer'}>
